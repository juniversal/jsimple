    ...
    public class WindowUniversalHttpRequest : HttpRequest
    {
        ...
        public override void setHeader(string name, string value)
        {
            ...
            if (name.Equals(HEADER_ACCEPT))
                ...
                throw new BasicException("Setting Content-Length isn't currently supported for HttpWebRequest; we should probably change the Windows universal app code to use HttpClient instead of the semi-deprecated HttpWebRequest");
        ...
        public override HttpResponse send()
        {
            ...
            return new WindowsUniversalHttpResponse(response);
        }
...
        }
        ...
        public class WindowsPhoneHttpRequestFactory : HttpRequestFactory
        {
            ...
            {
                return new WindowUniversalHttpRequest(url);
            }
        };
