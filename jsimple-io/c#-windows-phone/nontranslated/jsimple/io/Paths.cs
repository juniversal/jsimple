...
namespace jsimple.io
{
    public class Paths : PathsBase
    {
        ...
        static volatile StorageFolderDirectory applicationDataDirectory = null;
        ...
        public static Directory ApplicationDataDirectory
        {
            get
            {
                if (applicationDataDirectory == null)
                {
                    ...
                    {
                        if (applicationDataDirectory == null)
                            applicationDataDirectory = new StorageFolderDirectory(ApplicationData.Current.LocalFolder);
                    }
                }
