...
namespace jsimple.io
{
	...
	public class Utf8InputStreamReaderTest : jsimple.unit.UnitTest
	{
		...
		[Test] public virtual void testRead()
		{
			...
			InputStream unicodeFile = (new FileSystemFile(JavaProjectDirectory + "/src/test/resources/UTF-8-test.unicode")).openForRead();
			...
			InputStream utf8File = (new FileSystemFile(JavaProjectDirectory + "/src/test/resources/UTF-8-test.utf8")).openForRead();
