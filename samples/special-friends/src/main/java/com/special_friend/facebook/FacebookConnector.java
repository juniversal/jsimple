...
/**
 * Facebook raw-data extractor 
 * Specialized class that composes parameters and request specific strings in order to form 
...
public class FacebookConnector extends Connector {
	 ...
	 * @param postLimit how many posts to extract from the timeline , as the number increases the slower 
