...
namespace jsimple.json
{
	...
	public class JsonSerializerTest : jsimple.unit.UnitTest
	{
		...
		{
			assertSerializedJsonIs((new JsonObject()).add("num", 3).add("escape", "\\ \" / \r \n \t \f \b").add("control", "\0 \u0001 \u001F \u0020 \u007F \u009F \u00A0").add("longmax", long.MaxValue).add("longmin", long.MinValue).add("bool", true).add("bool2", false).add("nul", JsonNull.singleton).add("emptyobj", new JsonObject()).add("obj", (new JsonObject()).add("val", "abc")), "{", "  \"num\": 3,", "  \"escape\": \"\\\\ \\\" / \\r \\n \\t \\f \\b\",", "  \"control\": \"\\u0000 \\u0001 \\u001F \u0020 \\u007F \\u009F \u00A0\",", "  \"longmax\": " + long.MaxValue + ",", "  \"longmin\": " + long.MinValue + ",", "  \"bool\": true,", "  \"bool2\": false,", "  \"nul\": null,", "  \"emptyobj\": {},", "  \"obj\": {", "    \"val\": \"abc\"", "  }", "}");
		}
