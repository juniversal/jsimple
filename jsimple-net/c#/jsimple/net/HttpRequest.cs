...
namespace jsimple.net
{
	...
	public abstract class HttpRequest
	{
		...
		{
			if (factory == null)
				throw new Exception("HttpRequest factory isn't set; did you forget to call JSimpleNet.init()?");
		...
		/// and just call JSimpleNet.init at app startup instead, which sets the factory to the default implementation
