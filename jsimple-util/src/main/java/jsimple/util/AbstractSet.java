...
public abstract class AbstractSet<E> extends AbstractCollection<E> implements Set<E> {
     ...
     * That's so-called deep equality.   Whereas C#, on the other hand, just does reference equality
     * by default for sets, saying two are equal if their references are equals.
     * <p/>
     * There are two main reasons we differ from standard Java and don't support equals here for collection
     * classes:
     * <p/>
     * (a) The desired semantics are ambiguous (deep, shallow, or reference equality?  set type matter?).
     * Different semantics are appropriate in different cases.
