...
public class ArrayListTest extends UnitTest {
	...
	public void testConstructorFromArray() {
		...
		ArrayList<Object> al = ArrayList.create(objArray);
	...
	public void testArrayListAddAll() {
		...
		for (int index = 0; index < size; index++) {
			assertEquals(new Integer(1), arrayListA.get(index));
		}
	}
	...
	public void testArrayListAddAll1() {
		...
		for (int index = 0; index < size; index++) {
			assertEquals(new Integer(1), arrayList.get(index));
		}
	}
	...
	public void testContains() {
		...
		assertTrue("Returned false for equal element", alist.contains(new Integer(8)));
	...
	public void testRemove() {
		...
		List<String> list = ArrayList.create("a", "b", "c", "d", "e", "f", "g");
	...
	public void testOrder() {
		...
		for (int i = 1000; i < 0; i--) {
			assertEquals(sut.get(i), new Integer(i));
